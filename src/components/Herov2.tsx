...
<p className="max-w-[700px] mb-9 mt-3 text-white/80 ">
            with 1+ year of experience building dynamic web and mobile applications using React.js, Next.js, React Native, Express.js, Redux, Javascript and Typescript. Proficient in integrating AI-driven APIs and optimizing UI performance, eager to contribute to innovative startup projects.
          </p>
