    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-green-100 text-[18px] font-bold cursor-pointer flex">
            My&nbsp;
        ...
        <ul className="list-none hidden sm:flex flex:grow gap-10">
          {navLinks.map((link) => (
            <li
              key={link.id}
              className={`${
                active === link.title ? "text-cyan-200" : "text-cyan-200"
        ...
        <div className="sm:hidden flex flex-1 justify-end items-center">
          ...
          >
            <ul className="list-none flex-col justify-end items-start flex-4 gap-4">
              {navLinks.map((link) => (
                <li
                  key={link.id}
                  className={`${
